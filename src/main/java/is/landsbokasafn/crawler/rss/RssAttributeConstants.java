...
public interface RssAttributeConstants {
    String RSS_URI_TYPE = "rssUriType";
    String RSS_MOST_RECENTLY_SEEN = "rssLastFetchTime";
    String RSS_SITE = "rssSite";
    String RSS_IMPLIED_LINKS = "rssImpliedLinks";

    String LAST_CONTENT_DIGEST = "lastContentDigest";
    String LAST_FETCH_TIME = "lastFetchTime";
